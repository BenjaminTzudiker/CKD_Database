...
drop table site_source cascade if exists;
...
,SMOKE_END_DATE               
,ALCOHOL_USER                    
,ALCOHOL_OUNCE_PER_WEEK                  
,ALCOHOL_COMMENT                   
,ALCOHOL_TYPE                   
,IV_DRUG_USER             
,ILLICIT_DRUG_FREQUENCY               
,ILLICIT_DRUG_COMMENT        
)
from :path_social_history
with delimiter as ',' null as '' csv header quote as '"'/* force null SEXUALLY_ACTIVE,FEMALE_PARTNER                  
,MALE_PARTNER                   
,SMOKING_STATUS                   
,TOBACCO_PACK_PER_DAY             
,TOBACCO_USE_YEARS               
