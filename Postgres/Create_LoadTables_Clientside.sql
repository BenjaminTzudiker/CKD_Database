...
\copy social_history (SITE_SOURCE, encounter_id, PATIENT_ID, SEXUALLY_ACTIVE, FEMALE_PARTNER, MALE_PARTNER, SMOKING_STATUS, TOBACCO_PACK_PER_DAY, TOBACCO_USE_YEARS, TOBACCO_USER, CIGARETTES, PIPES, CIGARS, SNUFF, CHEW, SMOKE_START_DATE, SMOKE_END_DATE, ALCOHOL_USER, ALCOHOL_OUNCE_PER_WEEK, ALCOHOL_COMMENT, ALCOHOL_TYPE, IV_DRUG_USER, ILLICIT_DRUG_FREQUENCY, ILLICIT_DRUG_COMMENT) from '/Users/benjamintzudiker/Documents/SQL/Social_History.csv' with delimiter as ',' null as '' csv header quote as '"';
